...
describe('formatPrice function', () => {
  test('should returns formatted number with default currency and 2 decimals', () => { });
  test('should returns formatted number with custom currency symbol and decimals', () => {});
...
describe('Status component', () => {
  ...
  test('should toggle the status by clicking the button', () => {});
});
